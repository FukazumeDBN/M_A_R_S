...
from app.mars.backup import BackupService
...
from app.mars.scheduler import ScheduleValidationError, SystemdScheduler, calendar_expression, interval_expression, validate_time
...
class FakeTerminal:
    ...
    def is_idle(self) -> bool:
        return self.present and not self.child_processes()
...
class MarsCoreTests(unittest.TestCase):
    def test_schedule_validation(self):
        ...
        self.assertEqual(interval_expression(12, "hours"), "12h")
        self.assertEqual(interval_expression(3, "days"), "3d")
        with self.assertRaises(ScheduleValidationError):
            interval_expression(0, "hours")
    ...
    def test_systemd_scheduler_writes_owned_units(self):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertEqual(expression, "24h")
            ...
            self.assertIn("OnActiveSec=24h", timer)
